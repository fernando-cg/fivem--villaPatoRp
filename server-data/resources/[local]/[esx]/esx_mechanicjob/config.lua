...
Config.Zones = {
	...
	Garage = {
		Pos   = { x = -201.13, y = -1317.86, z = 30.09 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = 1
	},
	...
	VehicleSpawnPoint = {
		Pos   = { x = -163.49, y = -1302.49, z = 31.31 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		heading = 270.6,
		Type  = -1
	},
	...
	VehicleDeleter = {
		Pos   = { x = -148.36, y = -1296.92, z = 30.03 },
		Size  = { x = 3.0, y = 3.0, z = 1.0 },
		Color = { r = 146, g = 43, b = 33 },
		Type  = 1
	},

	VehicleDelivery = {
		Pos   = { x = -188.4, y = -1267.26, z = 30.38 },
		Size  = { x = 20.0, y = 35.0, z = 3.0 },
		Color = { r = 204, g = 204, b = 0 },
		Type  = -1
	}
}
