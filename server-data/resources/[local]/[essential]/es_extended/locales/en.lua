Locales['en'] = {
  ...
  ['gave_weapon'] = 'Tu has dado ~b~%s~s~ a ~y~%s~s~',
  ['gave_weapon_ammo'] = 'Tu has dado ~o~%sx %s~s~ para ~b~%s~s~ a ~y~%s~s~',
  ...
  ['received_weapon_ammo'] = 'Has recibido ~o~%sx %s~s~ Para ti ~b~%s~s~ de ~b~%s~s~',
  ['received_weapon_withammo'] = 'tu has recibido ~b~%s~s~ Con ~o~%sx %s~s~ de ~b~%s~s~',
  ['received_weapon_hasalready'] = '~b~%s~s~ te han intentado dar un arma ~y~%s~s~, Pero tu ya tienes una',
  ['received_weapon_noweapon'] = '~b~%s~s~ Intento de dar un arma a  ~y~%s~s~, pero no tienes ninguna',
  ...
  ['ex_inv_lim'] = 'accion imposible te estas excediendo del limite por ~y~%s~s~',
  ['imp_invalid_quantity'] = 'acion imposible cantidad invalida',
  ['imp_invalid_amount'] = 'Accion imposible cantidad invalida',
  ['threw_standard'] = 'Has lanzado ~y~%sx~s~ ~b~%s~s~',
  ['threw_account'] = 'Has lanzado ~g~$%s~s~ ~b~%s~s~',
  ['threw_weapon'] = 'has lanzado ~b~%s~s~',
  ['threw_weapon_ammo'] = 'Tu has lanzado ~b~%s~s~ con ~o~%sx %s~s~',
  ['threw_weapon_already'] = 'Ya llevas este arma en tu inventario',
  ['threw_cannot_pickup'] = 'No puedes cogerlo porque tu inventario esta lleno!',
  ['threw_pickup_prompt'] = 'pulsa ~y~E~s~ para cogerlo',
