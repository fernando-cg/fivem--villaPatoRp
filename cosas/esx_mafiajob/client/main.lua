    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'mafia' then
      ...
      for k,v in pairs(Config.MafiaStations) do
        ...
        for i=1, #v.Helicopters, 1 do
          ...
          if GetDistanceBetweenCoords(coords,  v.Helicopters[i].Spawner.x,  v.Helicopters[i].Spawner.y,  v.Helicopters[i].Spawner.z,  true) < 1442.992 then
            isInMarker     = true
            currentStation = k
