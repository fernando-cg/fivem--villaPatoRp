...
mumbleConfig = {
	...
	voiceModes = {
		...
		{12.0, "Gritar"}, -- Shout speech distance in gta distance units
	},
	speakerRange = 1.0, -- Speaker distance in gta distance units (how close you need to be to another player to hear other players on the radio or phone)
